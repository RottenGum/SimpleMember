...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        newsID: "20", //添加自定义参数newsID     //为编辑器实例添加一个路径，这个不能被注释
...
//                'print', 'preview', 'searchreplace', 'help', 'drafts']
 ...
 , toolbars: [
            ['fullscreen',  'undo', 'redo', '|',
                'bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript',  'autotypeset', 'blockquote', 'pasteplain', '|', 'forecolor', 'backcolor',  'insertunorderedlist', 'cleardoc', '|',
                'lineheight', '|',
