...
{
	public partial class ShopPayItemBus : IBusiness
	{
		#region 获取数据访问类

		private ShopPayItemDao _dao = null;

		/// <summary>
		/// 创建数据访问类
		/// </summary>
		/// <returns></returns>
		public ShopPayItemDao CreateDao()
		{
			return _dao ?? (_dao = new ShopPayItemDao());
		}
		...
		/// <param name="model">实体类</param>
		/// <returns></returns>
		public int InsertIdentity(ShopPayItem model)
		{
