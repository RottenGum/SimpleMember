...
{
	public partial class ShopOrderItemBus : IBusiness
	{
		#region 获取数据访问类

		private ShopOrderItemDao _dao = null;

		/// <summary>
		/// 创建数据访问类
		/// </summary>
		/// <returns></returns>
		public ShopOrderItemDao CreateDao()
		{
			return _dao ?? (_dao = new ShopOrderItemDao());
		}
		...
		/// <param name="model">实体类</param>
		/// <returns></returns>
		public int InsertIdentity(ShopOrderItem model)
		{
