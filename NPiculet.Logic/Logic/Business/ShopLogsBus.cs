...
{
	public partial class ShopLogsBus : IBusiness
	{
		#region 获取数据访问类

		private ShopLogsDao _dao = null;

		/// <summary>
		/// 创建数据访问类
		/// </summary>
		/// <returns></returns>
		public ShopLogsDao CreateDao()
		{
			return _dao ?? (_dao = new ShopLogsDao());
		}
		...
		/// <param name="model">实体类</param>
		/// <returns></returns>
		public int InsertIdentity(ShopLogs model)
		{
