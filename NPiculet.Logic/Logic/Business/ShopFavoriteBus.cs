...
{
	public partial class ShopFavoriteBus : IBusiness
	{
		#region 获取数据访问类

		private ShopFavoriteDao _dao = null;

		/// <summary>
		/// 创建数据访问类
		/// </summary>
		/// <returns></returns>
		public ShopFavoriteDao CreateDao()
		{
			return _dao ?? (_dao = new ShopFavoriteDao());
		}
		...
		/// <param name="model">实体类</param>
		/// <returns></returns>
		public int InsertIdentity(ShopFavorite model)
		{
