...
{
	public partial class ShopCommodityBus : IBusiness
	{
		#region 获取数据访问类

		private ShopCommodityDao _dao = null;

		/// <summary>
		/// 创建数据访问类
		/// </summary>
		/// <returns></returns>
		public ShopCommodityDao CreateDao()
		{
			return _dao ?? (_dao = new ShopCommodityDao());
		}
		...
		/// <param name="model">实体类</param>
		/// <returns></returns>
		public int InsertIdentity(ShopCommodity model)
		{
