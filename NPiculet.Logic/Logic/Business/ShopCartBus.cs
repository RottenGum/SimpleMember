...
{
	public partial class ShopCartBus : IBusiness
	{
		#region 获取数据访问类

		private ShopCartDao _dao = null;

		/// <summary>
		/// 创建数据访问类
		/// </summary>
		/// <returns></returns>
		public ShopCartDao CreateDao()
		{
			return _dao ?? (_dao = new ShopCartDao());
		}
		...
		/// <param name="model">实体类</param>
		/// <returns></returns>
		public int InsertIdentity(ShopCart model)
		{
		...
		/// <returns></returns>
		public bool Update(ShopCart model, string whereString = null)
		{
		...
		/// <param name="whereString">查询条件</param>
		/// <returns></returns>
		public ShopCart QueryModel(string whereString)
		{
		...
		/// <returns></returns>
		public List<ShopCart> QueryList(int curPage, int pageSize = 10, string whereString = null, string orderBy = null)
		{
		...
		/// <param name="orderBy">排序</param>
		/// <returns></returns>
		public List<ShopCart> QueryList(string whereString, string orderBy = null)
		{
