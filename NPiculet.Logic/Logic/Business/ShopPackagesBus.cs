...
{
	public partial class ShopPackagesBus : IBusiness
	{
		#region 获取数据访问类

		private ShopPackagesDao _dao = null;

		/// <summary>
		/// 创建数据访问类
		/// </summary>
		/// <returns></returns>
		public ShopPackagesDao CreateDao()
		{
			return _dao ?? (_dao = new ShopPackagesDao());
		}
		...
		/// </summary>
		/// <returns></returns>
		public ShopPackages CreateModel()
		{
			return new ShopPackages();
		}
		...
		/// <returns></returns>
		public bool Insert(ShopPackages model)
		{
		...
		/// <param name="model">实体类</param>
		/// <returns></returns>
		public int InsertIdentity(ShopPackages model)
		{
		...
		/// <returns></returns>
		public bool Update(ShopPackages model, string whereString = null)
		{
		...
		/// <param name="whereString">查询条件</param>
		/// <returns></returns>
		public ShopPackages QueryModel(string whereString)
		{
		...
		/// <returns></returns>
		public List<ShopPackages> QueryList(int curPage, int pageSize = 10, string whereString = null, string orderBy = null)
		{
		...
		/// <param name="orderBy">排序</param>
		/// <returns></returns>
		public List<ShopPackages> QueryList(string whereString, string orderBy = null)
		{
