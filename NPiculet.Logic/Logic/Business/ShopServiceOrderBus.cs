...
{
	public partial class ShopServiceOrderBus : IBusiness
	{
		#region 获取数据访问类

		private ShopServiceOrderDao _dao = null;

		/// <summary>
		/// 创建数据访问类
		/// </summary>
		/// <returns></returns>
		public ShopServiceOrderDao CreateDao()
		{
			return _dao ?? (_dao = new ShopServiceOrderDao());
		}
		...
		/// <param name="model">实体类</param>
		/// <returns></returns>
		public int InsertIdentity(ShopServiceOrder model)
		{
