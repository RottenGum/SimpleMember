...
{
	public partial class ShopCommodityPriceBus : IBusiness
	{
		#region 获取数据访问类

		private ShopCommodityPriceDao _dao = null;

		/// <summary>
		/// 创建数据访问类
		/// </summary>
		/// <returns></returns>
		public ShopCommodityPriceDao CreateDao()
		{
			return _dao ?? (_dao = new ShopCommodityPriceDao());
		}
		...
		/// </summary>
		/// <returns></returns>
		public ShopCommodityPrice CreateModel()
		{
			return new ShopCommodityPrice();
		}
		...
		/// <returns></returns>
		public bool Insert(ShopCommodityPrice model)
		{
		...
		/// <param name="model">实体类</param>
		/// <returns></returns>
		public int InsertIdentity(ShopCommodityPrice model)
		{
		...
		/// <returns></returns>
		public bool Update(ShopCommodityPrice model, string whereString = null)
		{
		...
		/// <param name="whereString">查询条件</param>
		/// <returns></returns>
		public ShopCommodityPrice QueryModel(string whereString)
		{
		...
		/// <returns></returns>
		public List<ShopCommodityPrice> QueryList(int curPage, int pageSize = 10, string whereString = null, string orderBy = null)
		{
		...
		/// <param name="orderBy">排序</param>
		/// <returns></returns>
		public List<ShopCommodityPrice> QueryList(string whereString, string orderBy = null)
		{
