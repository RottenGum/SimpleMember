...
{
	public partial class ShopOrderFlowBus : IBusiness
	{
		#region 获取数据访问类

		private ShopOrderFlowDao _dao = null;

		/// <summary>
		/// 创建数据访问类
		/// </summary>
		/// <returns></returns>
		public ShopOrderFlowDao CreateDao()
		{
			return _dao ?? (_dao = new ShopOrderFlowDao());
		}
		...
		/// </summary>
		/// <returns></returns>
		public ShopOrderFlow CreateModel()
		{
			return new ShopOrderFlow();
		}
		...
		/// <returns></returns>
		public bool Insert(ShopOrderFlow model)
		{
		...
		/// <param name="model">实体类</param>
		/// <returns></returns>
		public int InsertIdentity(ShopOrderFlow model)
		{
		...
		/// <returns></returns>
		public bool Update(ShopOrderFlow model, string whereString = null)
		{
		...
		/// <param name="whereString">查询条件</param>
		/// <returns></returns>
		public ShopOrderFlow QueryModel(string whereString)
		{
		...
		/// <returns></returns>
		public List<ShopOrderFlow> QueryList(int curPage, int pageSize = 10, string whereString = null, string orderBy = null)
		{
		...
		/// <param name="orderBy">排序</param>
		/// <returns></returns>
		public List<ShopOrderFlow> QueryList(string whereString, string orderBy = null)
		{
