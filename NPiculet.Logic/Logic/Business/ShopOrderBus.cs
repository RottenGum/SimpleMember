...
{
	public partial class ShopOrderBus : IBusiness
	{
		#region 获取数据访问类

		private ShopOrderDao _dao = null;

		/// <summary>
		/// 创建数据访问类
		/// </summary>
		/// <returns></returns>
		public ShopOrderDao CreateDao()
		{
			return _dao ?? (_dao = new ShopOrderDao());
		}
		...
		/// <param name="model">实体类</param>
		/// <returns></returns>
		public int InsertIdentity(ShopOrder model)
		{
