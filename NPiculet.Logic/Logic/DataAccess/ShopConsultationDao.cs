...
{
	public partial class ShopConsultationDao : DataDao, IDao<ShopConsultation>
	{
		#region 获取数据实体类
		...
		{
			return base.Delete<ShopConsultation>(whereString);
		}
		...
		{
			return base.Query<ShopConsultation>(whereString, orderBy);
		}
		...
		{
			return base.Query<ShopConsultation>(curPage, pageSize, whereString, orderBy);
		}
		...
		{
			return base.QueryModel<ShopConsultation>(whereString);
		}
		...
		{
			return base.QueryList<ShopConsultation>(curPage, pageSize, whereString, orderBy);
		}
		...
		{
			return base.QueryList<ShopConsultation>(whereString, orderBy);
		}
		...
		{
			return base.RecordCount<ShopConsultation>(whereString);
		}
