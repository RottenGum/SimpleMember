...
namespace NPiculet.Logic.Data
{
	...
	/// 
	/// </summary>
	public partial class ShopOrderFlow : ModelBase
	{
		public override string TableName { get { return "shop_order_flow"; } }
		...
		/// 
		/// </summary>
		[Column(Field = "SourceOrderCode", Type = "varchar", Length = 192, Scale = 0)]
		public string SourceOrderCode
		{
			get { return _sourceOrderCode; }
			set
			{
				OnPropertyChanging("SourceOrderCode");
				_sourceOrderCode = value;
				OnPropertyChanged("SourceOrderCode");
			}
		}
