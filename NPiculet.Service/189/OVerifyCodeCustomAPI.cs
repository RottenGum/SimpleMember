...
{
	public class OVerifyCodeCustomAPI
	{
		private string _api = "http://api.189.cn/v2/dm/randcode/sendSms";
		private string _appId;
		//private string _appSecret;
		private string _accessToken;

		public OVerifyCodeCustomAPI(string appId, string accessToken)
		{
			_appId = appId;
